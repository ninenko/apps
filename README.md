...
1. Сохрани HTML-файл в папку `apps/` (интерактивные приложения) или `lectures/` (слайды)
...
```
HTML public/
├── apps/       ← интерактивные приложения, инструменты, игры
├── lectures/   ← слайды и презентации
